...
resource "azurerm_application_gateway" "hub-application-gateway" {
  ...
  frontend_ip_configuration {
    ...
    private_ip_address            = "10.221.1.134"
  }

  backend_address_pool {
    name = var.backend_address_pool_name //"myBackendPool"
    ip_addresses = [azurerm_network_interface.site1-vm-nic.private_ip_address, azurerm_network_interface.site2-vm-nic.private_ip_address]
  }

  backend_http_settings {
    name                  = var.http_setting_name //"myHTTPsetting"
